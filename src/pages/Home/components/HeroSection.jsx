  ...
  return (
    <section className="relative h-screen w-full overflow-hidden font-sans group">
      ...
      >
        ...
        <div className="absolute inset-0 bg-black/50 md:bg-gradient-to-tr md:from-black md:via-black/40 md:to-transparent opacity-90"></div>
      </div>
      ...
      {/* Aesthetic Scroll Indicator - Hidden on small mobile heights */}
