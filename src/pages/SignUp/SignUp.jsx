  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f8fafc] dark:bg-zinc-900 p-6 font-sans transition-colors duration-300">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-[10%] -right-[10%] w-[40%] h-[40%] rounded-full bg-blue-50 dark:bg-blue-900/20 blur-[120px]" />
        <div className="absolute -bottom-[10%] -left-[10%] w-[40%] h-[40%] rounded-full bg-purple-50 dark:bg-purple-900/20 blur-[120px]" />
      </div>
      ...
      >
        <div className="bg-white/80 dark:bg-zinc-800/80 backdrop-blur-xl border border-white dark:border-zinc-700 rounded-[2rem] shadow-2xl dark:shadow-black/50 p-10 space-y-8 transition-colors">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full bg-gray-900 dark:bg-white text-white dark:text-gray-900 py-4 rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-black dark:hover:bg-gray-200 hover:shadow-lg hover:shadow-black/10 dark:hover:shadow-white/10 transition-all duration-200 active:scale-[0.98] mt-2"
            >
              {t("GetStarted")}
              <ArrowRight size={18} />
            </button>
