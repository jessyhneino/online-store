  ...
  return (
    <>
      ...
      >
        ...
        {/* زر إغلاق */}
        <button
          className="absolute top-3 right-3 md:hidden p-1 rounded-full hover:bg-gray-200 dark:hover:bg-zinc-800 transition-colors"
          onClick={onClose}
        >
          ...
          <div className="space-y-2 md:space-y-3">
            {categories.map((cat) => (
              ...
              >
                <input
                  type="checkbox"
                  className="w-4 h-4 md:w-4 md:h-4 border-gray-300 dark:border-zinc-700 rounded accent-black dark:accent-blue-500"
                  defaultChecked={cat === t("Accessories")}
                />
                <span className="text-sm md:text-sm text-gray-600 dark:text-gray-300 group-hover:text-black dark:group-hover:text-white transition-colors font-medium">
                  {cat}
                </span>
              </label>
            ))}
        ...
        <section>
          ...
          />
          <div className="flex justify-between text-[11px] mt-2 text-gray-500 dark:text-gray-400 font-medium">
            <span>$0</span>
            <span>$1000</span>
          </div>
        </section>
